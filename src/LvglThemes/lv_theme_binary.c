...
#define COLOR_FG      dark_bg ?  lv_color_black() : lv_color_white() 
#define COLOR_BG      dark_bg ?  lv_color_white() : lv_color_black() 
 ...
 *  STATIC VARIABLES
 **********************/
static my_theme_styles_t * styles = NULL;
...
static void style_init(bool dark_bg, const lv_font_t * font)
{
    ...
    lv_style_set_width(&styles->scrollbar,  SCROLL_WIDTH);
    ...
    lv_style_set_anim_speed(&styles->scr, DEFAULT_ANIM_SPEED);
    ...
    lv_style_set_radius(&styles->card, 1);
    ...
    lv_style_set_arc_width(&styles->card, 1);
    ...
    lv_style_set_bg_opa(&styles->focus, LV_OPA_COVER); 
    lv_style_set_outline_width(&styles->focus, 1);
    lv_style_set_outline_pad(&styles->focus, BORDER_W_FOCUS);
    
    lv_style_set_bg_color(&styles->focus, COLOR_FG);
    lv_style_set_border_color(&styles->focus, COLOR_BG);
    lv_style_set_line_color(&styles->focus, COLOR_BG);
    lv_style_set_arc_color(&styles->focus, COLOR_BG); 
    lv_style_set_text_color(&styles->focus, COLOR_BG); 
    ...
    lv_style_set_border_width(&styles->no_border, BORDER_W_OFF);
    ...
    // Label style
    style_init_reset(&styles->list_button_label);
    lv_style_set_anim_speed(&styles->list_button_label, LABEL_ANIM_SPEED);
...
static void theme_apply(lv_theme_t * th, lv_obj_t * obj)
{
    ...
    if(lv_obj_check_type(obj, &lv_obj_class)) {
        ...
        //lv_obj_add_style(obj, &styles->card, 0);
        lv_obj_add_style(obj, &styles->no_border, 0);
    ...
    // List Buttons Text
        ...
        lv_obj_add_style(obj, &styles->list_button_label, 0);
    }
    // List Buttons itself
